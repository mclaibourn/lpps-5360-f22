...
If you already have R installed, check the version (you'll see the R version when you first start RStudio, or type `R.version.string` in the console -- it's worth making sure you're using a 4.x.x version. If yours is older, it's worth updating.
...
2. Type the name of the package you want (`tidyverse`) to install in the pop-up window, and press Install.[^1]
...
[^1]: Alternatively, you could type `install.packages("tidyverse")` into the console and run it.
