...
There are many online resources to consult. Two of the most useful are [StackOverflow](https://stackoverflow.com/) (a Q&A site with hundreds of thousands of answers to all sorts of programming questions) and [RStudio Community](https://community.rstudio.com/) (a forum specifically designed for people using RStudio).
...
Once you have read the syllabus and you have R, RStudio, and the tidyverse set up on your computer ([instructions for installing R, RStudio, and all the tidyverse packages](../install/)), email me a picture of a panda at [mclaibourn@virginia.edu](mailto:mclaibourn@virginia.edu) and I will invite you to the class slack!
